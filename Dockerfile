...
WORKDIR /src
COPY ["reservations-main/reservation-system.csproj", "reservations-main/"]
RUN dotnet restore "reservations-main/reservation-system.csproj"
COPY . .
WORKDIR "/src/reservations-main"
